...
function handleFile(file) {
  ...
  read.onloadend = () => {
    ...
    sessionStorage.setItem('svg-data', removeLineBreaks(read.result));
    navigate(DISPLAY_PATH);
  }
}
